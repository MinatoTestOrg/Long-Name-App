package com.minatostabilityorganization.test.base.service;
...
public class TestBaseService<T extends TestBase> extends BaseBusinessLogic<T>
		implements ITestBaseService<T> {
	...
	public TestBaseService(Class<T> modelClass) {
		super(modelClass);
	...
	public void onAfterSaveDB(T modelObj) {
	  changelogService.createChangeLog("Test", modelObj.getSid(), Constants.SAVED, modelObj);
	}
	...
	public void onAfterUpdateDB(T modelObj) {
	  changelogService.createChangeLog("Test", modelObj.getSid(), Constants.UPDATED, modelObj);
	}
	...
	public void onAfterDeleteDB(T modelObj) {
	  changelogService.createChangeLog("Test", modelObj.getSid(), Constants.DELETED, modelObj);
	}	
